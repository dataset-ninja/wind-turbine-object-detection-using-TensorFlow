...
##################################
PROJECT_NAME: str = "Wind Turbine Detection (by Luke Borkowski)"
...
RELEASE_DATE: Optional[str] = "2019-07-01"  # e.g. "YYYY-MM-DD"
...
DOWNLOAD_ORIGINAL_URL: Optional[
    Union[str, dict]
] = "https://github.com/lbborkowski/wind-turbine-detector/archive/refs/heads/master.zip"
...
AUTHORS: Optional[List[str]] = ["Luke Borkowski"]
AUTHORS_CONTACTS: Optional[List[str]] = ["lbborkowski@gmail.com"]
